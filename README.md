...
|-----------|------------|-------------|
| **Frontend** | HTML5, CSS3 | Semantic structure and responsive flexbox/grid layout. |
| **Logic** | JavaScript (ES6+) | `Fetch API` for async data retrieval and DOM manipulation. |
| **Mapping** | [Leaflet.js](https://leafletjs.com/) | Open-source interactive maps. |
| **Charts** | [Chart.js](https://www.chartjs.org/) | Canvas-based data visualization. |
| **Basemap** | CARTO | CartoDB Dark Matter tiles for high-contrast visualization. |

---

## 📂 Project Structure

myanmar-seismicity-dashboard/ ├── index.html # Main application structure ├── styles.css # Dark theme styling and layout ├── app.js # Core logic (API fetch, Map rendering, Charts) ├── README.md # Project documentation └── preview.png # (Optional) Screenshot for GitHub repo
...
git clone [https://github.com/your-username/myanmar-seismicity-dashboard.git](https://github.com/your-username/myanmar-seismicity-dashboard.git)
Open the project: Simply open index.html in any modern web browser (Chrome, Firefox, Edge, Safari).
