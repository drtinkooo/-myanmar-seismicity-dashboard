...
Tectonic lineaments are loaded from an external GeoJSON file sourced from the **Myanmar Tectonic Map 2011**. The URL is defined in `app.js` as `CONFIG.tectonicUrl`.
